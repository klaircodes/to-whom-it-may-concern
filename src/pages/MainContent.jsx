...
function MainContent() {
  ...
  const [compliment, setCompliment] = useState("Your rizz goes here.");
  ...
  const generateCompliment = async () => {
    setIsAnimating(true);
    setIsLoading(true);
    const defaultFallback = "Your rizz goes here.";
    let gotText = "";
    try {
  ...
  return (
    <div style={{ display: "flex" }}>
        ...
        <Pop className="w-full max-w-3xl mx-auto bg-div shadow-2xl font-pixel pixel-corners">
          ...
          >
            ...
            <div className="flex space-x-2">
              <span className="bg-none px-2 py-2 text-xs border-2 border-white cursor-pointer hover:scale-105 font-pixel-paragraph flex items-center justify-center text-secondary rounded-sm">
                <FiMinus className="thick-svg" />
              </span>
              <span className="bg-none px-2 py-2 text-xs border-2 border-white cursor-pointer hover:scale-105 font-pixel-paragraph flex items-center justify-center text-secondary rounded-sm">
                <FiSquare className="thick-svg" />
              </span>
              <span className="bg-none px-2 py-2 text-xs border-2 border-white cursor-pointer hover:scale-105 font-pixel-paragraph flex items-center justify-center text-secondary rounded-sm">
                <FiX className="thick-svg" />
              </span>
            </div>
          </Pop>
          ...
          <div className="flex relative">
            ...
            <div className="flex-1 bg-grid-gradient p-4 relative">
              ...
              <div className="text-center">
                ...
                >
                  <div className="mb-4 font-pixel-subheading">
      ...
      <div className="bg-none px-2 relative flex flex-col justify-end items-start space-y-2">
        <Pop delay={0.45} className="block">
          <button
            className=" bg-tertiary hover:opacity-80 text-secondary font-pixel-heading py-3 px-8 shadow-lg transform hover:scale-105 transition-all duration-200 pixel-corners disabled:opacity-60 custom-hover"
            onClick={handleFirstButtonClick}
            disabled={compliment === "Your rizz goes here."}
          >
            Use
          </button>
        </Pop>
