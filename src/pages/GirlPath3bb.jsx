...
import Dialogue3bb from "../dialogue/Dialogue3bb.jsx";
import clickSound from "../assets/sound/blip-select.mp3";
import GlitchEffect from "../components/GlitchEffect.jsx";

export default function GirlPath3bb() {
  const navigate = useNavigate();

  useEffect(() => {
    document.body.classList.add("girlpath3bb");
    return () => {
      document.body.classList.remove("girlpath3bb");
    };
  }, []);
