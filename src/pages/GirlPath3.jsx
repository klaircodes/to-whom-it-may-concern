...
import Dialogue3 from "../dialogue/Dialogue3.jsx";
import clickSound from "../assets/sound/blip-select.mp3";
import GlitchEffect from "../components/GlitchEffect.jsx";

export default function GirlPath3() {
  const navigate = useNavigate();

  useEffect(() => {
    document.body.classList.add("girlpath3");
    return () => {
      document.body.classList.remove("girlpath3");
    };
  }, []);
