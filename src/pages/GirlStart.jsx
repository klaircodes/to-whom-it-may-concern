        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div className="custom-hover bg-tertiary border-2 border-main rounded-sm flex-none h-5 flex items-center justify-center text-xs text-primary font-pixel-paragraph">
                ...
                <div className="custom-hoverbg-tertiary border-2 border-main rounded-sm flex-none h-5 flex items-center justify-center text-xs text-primary font-pixel-paragraph">
