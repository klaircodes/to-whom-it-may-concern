...
import Dialogue1ba from "../dialogue/Dialogue1ba.jsx";
import clickSound from "../assets/sound/blip-select.mp3";
import GlitchEffect from "../components/GlitchEffect.jsx";

export default function GirlPath1ba() {
  const navigate = useNavigate();

  useEffect(() => {
    document.body.classList.add("girlpath1ba");
    return () => {
      document.body.classList.remove("girlpath1ba");
    };
  }, []);
