...
import Dialogue3ba from "../dialogue/Dialogue3ba.jsx";
import clickSound from "../assets/sound/blip-select.mp3";
import GlitchEffect from "../components/GlitchEffect.jsx";

export default function GirlPath3ba() {
  const navigate = useNavigate();

  useEffect(() => {
    document.body.classList.add("girlpath3ba");
    return () => {
      document.body.classList.remove("girlpath3ba");
    };
  }, []);
