...
import Dialogue3b from "../dialogue/Dialogue3b.jsx";
import clickSound from "../assets/sound/blip-select.mp3";
import GlitchEffect from "../components/GlitchEffect.jsx";

export default function GirlPath3b() {
  const navigate = useNavigate();

  useEffect(() => {
    document.body.classList.add("girlpath3b");
    return () => {
      document.body.classList.remove("girlpath3b");
    };
  }, []);
  ...
  const handleFirstButtonClick = () => {
    playSound();
    navigate("/girlpath3ba");
  };

  const handleSecondButtonClick = () => {
    playSound();
    navigate("/girlpath3bb");
  };
