...
import ShitsAndSounds from './ShitsAndSounds.jsx';

export default function GirlStart() {
  return (
    <div className="big-container flex flex-col">
      {/* Upper Div */}
      <div className="upper-div flex">
        {/* Main Window */}
        <div className="relative flex flex-col items-center w-[500px] bg-none shadow-lg mt-8 mb-8" style={{ position: 'relative', zIndex: 2 }}>
          {/* Anime Girl*/}
          <Motion.img
            src={animeGirl}
            alt="Anime Girl"
        ...
        <div className="bg-none w-[400px] px-2 relative flex flex-col justify-end items-end mb-8 space-y-4" >
            <Pop delay={0.45} className="block">
              <button 
                className="bg-tertiary hover:opacity-80 text-secondary font-pixel-heading py-3 px-8 shadow-lg transform hover:scale-105 transition-all duration-200 pixel-corners disabled:opacity-60 w-[300px]"
              >
            ...
            <Pop delay={0.5} className="block">
              <button 
                className="bg-secondary hover:opacity-80 text-primary font-pixel-heading py-3 px-8 shadow-lg transform hover:scale-105 transition-all duration-200 pixel-corners disabled:opacity-60 w-[300px]"
              >
                "Uhhh.. hi... I guess..."
              </button>
            </Pop>
